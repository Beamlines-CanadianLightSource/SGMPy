...
def summary_plot_hdf5(energy_data, data, scan_num, name, start_energy=None, stop_energy=None):
	plt.close('all')
	if name == "TEY" or name == "I0" or name == "Diode" or name == "SDD1_OCR" or name == "SDD1_ICR" or name == "SDD2_OCR" or name == "SDD2_ICR" or name == "SDD3_OCR" or name == "SDD3_ICR" or name == "SDD4_OCR" or name == "SDD4_ICR":
		index_of_scan_num = generate_summary_plot_with_scaler_hdf5(energy_data, data, scan_num, name)
	elif name == "PFY_SDD1" or name == "PFY_SDD2" or name == "PFY_SDD3" or name == "PFY_SDD4":
		index_of_scan_num = generate_summary_plot_with_pfy_hdf5(energy_data, data, scan_num, name, start_energy, stop_energy)
	else:
...
def generate_summary_plot_with_pfy_hdf5(energy_data, mca_data, scan_nums, pfy_name, start_energy, stop_energy):
	...
	for index in range (0, total_cscan_num):
		...
		scan_num_list.fill(index+1)
		total_pfy = get_one_pfy_from_all_scan_hdf5(mca_data, mca_name, start_energy, stop_energy)
...
def get_one_pfy_from_all_scan_hdf5(mca_data, mca_name, enStart, enStop):
